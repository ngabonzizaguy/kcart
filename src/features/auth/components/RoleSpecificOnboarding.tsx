    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 flex flex-col pb-safe">
      ...
      <div className="pt-safe px-6 py-4">
        <div className="flex items-center justify-between mb-2 mt-4">
          ...
          <button
            onClick={handleSkip}
            className="text-gray-600 hover:text-gray-800 transition-colors text-sm font-medium px-4 py-2 rounded-xl hover:bg-white/50"
          >
      ...
      <div className="flex-1 px-6 py-8 flex flex-col items-center justify-center">
        <Card className="bg-white/90 backdrop-blur-md border border-white/30 w-full max-w-sm rounded-3xl">
        ...
        <div className="flex items-center gap-4">
          {currentSlide > 0 && (
            <Button
              onClick={prevSlide}
              variant="outline"
              className="flex-1 border-2 border-gray-200 text-gray-700 hover:bg-gray-50 rounded-xl h-12 text-base font-medium"
            >
