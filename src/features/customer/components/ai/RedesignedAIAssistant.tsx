...
export function RedesignedAIAssistant({ 
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent 
        side="bottom" 
        className="h-[80vh] bg-white/80 backdrop-blur-xl border-t border-gray-200/30 rounded-t-3xl"
      >
        ...
        <SheetHeader className="pb-6">
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/30 to-orange-600/30 rounded-2xl blur-lg" />
            </div>
          ...
          <SheetDescription className="text-gray-600 text-sm text-left">
        ...
        <div className="space-y-6 pb-6 overflow-y-auto scrollbar-hide">
          ...
          <div>
            <h3 className="text-gray-800 font-medium text-base mb-4 px-1">
                ...
                return (
                  <motion.button
                    ...
                    className={`w-full p-5 text-left rounded-3xl border transition-all duration-200 ${
                      isSelected 
                        ? 'bg-orange-500/10 border-orange-500/30 scale-95' 
                        : 'bg-white/60 backdrop-blur-md border-gray-200/30 hover:bg-white/80 hover:border-gray-200/50'
                    }`}
                    whileTap={{ scale: 0.98 }}
                    layout
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-colors ${
                        isSelected 
                          ...
                          : 'bg-gradient-to-br from-gray-100/50 to-gray-200/80 backdrop-blur-sm'
                      }`}>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {option.badge && (
                            <Badge 
                              variant="secondary" 
                              className="text-xs px-2 py-0.5 bg-orange-500/10 text-orange-600 border-orange-500/20"
                            >
