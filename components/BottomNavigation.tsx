  ...
  const renderAIFAB = () => {
    return (
      <div className="relative flex items-center justify-center">
        ...
        <motion.div
          className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-primary/30 to-orange-600/30 flex items-center justify-center"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.6, 0.2, 0.6],
          }}
        ...
        <motion.button
          ...
          className="relative w-14 h-14 bg-gradient-to-br from-primary via-orange-500 to-orange-600 rounded-full shadow-2xl shadow-primary/40 flex items-center justify-center overflow-hidden group"
          whileHover={{ 
            scale: 1.05,
