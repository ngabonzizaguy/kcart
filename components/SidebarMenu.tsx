      ...
      >
        ...
        <div className="p-6 border-b border-border/20 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-foreground">{content[language].title}</h2>
          ...
          {/* DeliGo Logo */}
          <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-primary/10 to-primary/20 rounded-2xl">
            ...
            <div>
              <p className="text-foreground font-medium">DeliGo</p>
              <p className="text-muted-foreground text-xs">{content[language].version}</p>
            </div>
          </div>
        </div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            {/* Icon */}
                            <div className="w-12 h-12 bg-muted/50 group-hover:bg-primary/10 rounded-xl flex items-center justify-center transition-colors">
        ...
        <div className="border-t border-border/50 bg-card/95 backdrop-blur-md p-6 flex-shrink-0">
          <Button
            onClick={onLogout}
            variant="outline"
            className="w-full h-12 rounded-xl border-destructive/20 text-destructive hover:bg-destructive hover:text-destructive-foreground transition-all"
          >
